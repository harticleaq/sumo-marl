...
def parse_args():
    ...
    parser.add_argument("--episode_limit", type=int, default=1400, help="每轮step限制")
    parser.add_argument('--alg', type=str, default='qmix', help='算法名称')
    parser.add_argument('--n_steps', type=int, default=14000000, help='总step')
    ...
    parser.add_argument('--anneal_steps', type=int, default=1400000, help='')
